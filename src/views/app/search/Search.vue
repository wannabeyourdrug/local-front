<template>
    <div>
        <b-button class="link-show" @click="isShownSearch = !isShownSearch" v-show="!isShownSearch" squared
            variant="info">Показать поля поиска</b-button>
        <transition name="fade">
            <b-row v-if="isShownSearch">
                <b-colxx xxs="12">
                            ...
                            <b-row>
                                ...
                                <b-colxx sm="4">
                                    <b-form-group label="Спонтанность или четкий план?">
                                        <b-form-select :options="['Спонтанность;', 'Четкий план.']"
                                            v-model="search.plan" plain />
                                    </b-form-group>
                                </b-colxx>
                                <b-colxx sm="8">
