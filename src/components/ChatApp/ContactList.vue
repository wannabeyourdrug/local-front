    ...
    <vue-perfect-scrollbar :settings="{ suppressScrollX: true, wheelPropagation: false }"  >
        <div class="pt-0 spaced-content pb-0">
            <div class="d-flex flex-row mb-3 border-bottom pb-3" v-for="(contact,index) in data" :key="`contact${index}`">
                ...
                <img :alt="contact.profile.anket.name" :src="contact.profile.picture" class="img-thumbnail border-0 rounded-circle mr-3 list-thumbnail align-self-center xsmall" />
